 ...
 * @author nguye
 */
@WebServlet(urlPatterns = {"/HTServlet_NguyenVanHuong"})
public class HTServlet_NguyenVanHuong extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet HTServlet_NguyenVanHuong</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet HTServlet_NguyenVanHuong at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
     ...
     * @throws IOException if an I/O error occurs
     */
private static final String JDBC_URL = "jdbc:mysql://localhost:3366/qlxemay";
    ...
    try (PrintWriter out = response.getWriter()) {
        ...
        try (Connection connection = DriverManager.getConnection(JDBC_URL, JDBC_USERNAME, JDBC_PASSWORD)) {
            ...
            out.println("</table>");
            out.println("<br><a href='Them_NguyenVanHuong.jsp'>Thêm xe máy mới</a>");
