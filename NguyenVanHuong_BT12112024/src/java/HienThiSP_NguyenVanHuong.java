 ...
 * @author nguye
 */
@WebServlet(urlPatterns = {"/HienThiSP_NguyenVanHuong"})
public class HienThiSP_NguyenVanHuong extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Danh sách sản phẩm</title>");
            out.println("<style>");
            out.println("body { font-family: Arial, sans-serif; background-color: #f4f4f9; color: #333; display: flex; justify-content: center; align-items: center; min-height: 100vh; margin: 0; }");
            ...
            out.println("h2, h3 { color: #333; margin-bottom: 20px; }");
            out.println(".message { color: #28a745; font-weight: bold; margin-bottom: 20px; }"); // Class for messages
            ...
            // Nội dung sẽ được thêm vào hàm doPost
            out.println("</div>");
            out.println("</body>");
            out.println("</html>");
        }
